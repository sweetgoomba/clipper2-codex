...
| W07 | 스토리보드 UI/UX 재설계 | 구현·후속 수정 및 집중 검증 기록 완료. 사용자 승인으로 코드 3repo feature/storyboard-ux-update 커밋·푸시(A18006cb0/N693edf6/W580211e), 작업 트리 clean. dev 병합 없음; 최신 dev 통합 시 검토·재검증 필요. 홈 카드 200px·새 프리셋·전체 복사/PDF·주제 근거 UI 제거 반영 | [구현 결과·검증 한계·Git 현황](tasks/storyboard.md) |
