...
> 제품 용어 기준은 2026-06-11에 갱신됐다. 유저에게 노출되는 개념은 `플러그인`과 `프로젝트` 두 개로 정리하고, `workflow`와 `job`은 기존 코드/기술 구조 설명에서만 사용한다. 최신 기준은 [PLUGIN_PROJECT_QUEUE_TERMINOLOGY_2026-06-11.md](PLUGIN_PROJECT_QUEUE_TERMINOLOGY_2026-06-11.md)를 먼저 본다.
